...
export default function AgentCard({
  ...
  return (
    ...
    >
      <Card
        data-market-card
        className="h-full min-h-[22rem] gap-0 border-border/75 bg-[#0b192d] py-0 shadow-[3px_3px_0_#040c18] transition-[transform,border-color] duration-150 ease-out group-hover:-translate-y-0.5 group-hover:border-primary/55"
      >
